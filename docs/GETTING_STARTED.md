...
4. **WebSocket-Eventstream testen**
 ...
 > **Hinweis:** Die Web-UI nutzt primär WebSocket (`/events/stream`) für Live-Updates
 > und fällt bei Verbindungsproblemen automatisch auf HTTP-Polling (`/events/recent`) zurück.
